...
# Import necessary variables from the config.py file
from config import CLIENT_ID, API_KEY, API_SERVER, EVENT_STREAM_NAME

# URL used to create new event streams
url = 'https://{}:{}@{}/v1/event_streams'.format(CLIENT_ID, API_KEY, API_SERVER)

# Get event stream name from config.py or Ask the user for an event stream name
if not EVENT_STREAM_NAME:
